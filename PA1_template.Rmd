...
```{r opts_chunk$set(echo=TRUE, fig.width=8, fig.height=6)}
...
#lengthNaRows <- length(activity[is.na(activity)])
#completeRows <- nrow(na.omit(activity))
...
#plot(stepsWeekDay$interval,stepsWeekDay$meanSteps,type="l")
#plot(stepsWeekEnd$interval,stepsWeekEnd$meanSteps,type="l")
require(gridExtra)
